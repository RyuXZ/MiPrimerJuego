...
if moving {
    ...
    if dir == 1 {
        sprite_index = spr_jrbarlog_rrwalk;  // Sprite de caminar a la derecha
    } else {
        sprite_index = spr_jrbarlog_lwalk;  // Sprite de caminar a la izquierda
    }
    ...
    if time_to_stop <= 0 {
        ...
        if facing_right {
            sprite_index = spr_jrbarlog_rstand;  // Sprite parado mirando a la derecha
        } else {
            sprite_index = spr_jrbarlog_lstand;  // Sprite parado mirando a la izquierda
        }
    }
} else {
